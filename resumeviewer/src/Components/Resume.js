				...
				<div className="nine columns main-col">
					...
					<div className="row item">
						...
						<div className="twelve columns">
							...
							<p className="info">
								Master in Graphic Design <span>&bull;</span> <em className="date">April 2007</em>
							</p>
					...
					<div className="row item">
						...
						<div className="twelve columns">
							...
							<p className="info">
								B.A. Degree in Graphic Design <span>&bull;</span> <em className="date">March 2003</em>
							</p>
				...
				<div className="nine columns main-col">
					...
					<div className="row item">
						...
						<div className="twelve columns">
							...
							<p className="info">
								Senior UX Designer <span>&bull;</span> <em className="date">March 2010 - Present</em>
							</p>
					...
					<div className="row item">
						...
						<div className="twelve columns">
							...
							<p className="info">
								UX Designer <span>&bull;</span> <em className="date">March 2007 - February 2010</em>
							</p>
							<p>
								This is Photoshop's version  of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet nibh vulputate cursus a sit amet mauris. Morbi accumsan ipsum velit. Nam nec tellus a odio tincidunt auctor a ornare odio. Sed non  mauris vitae erat
							</p>
